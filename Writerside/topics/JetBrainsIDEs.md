...
激活软件
<code-block>
cat >> ~/.local/share/JetBrains/Toolbox/apps/pycharm/bin/pycharm64.vmoptions <<'EOF'
-javaagent:$HOME/DevTools/jetbra/ja-netfilter.jar=jetbrains
...
激活软件
<code-block>
cat >> ~/.local/share/JetBrains/Toolbox/apps/phpstorm/bin/phpstorm64.vmoptions <<'EOF'
-javaagent:$HOME/DevTools/jetbra/ja-netfilter.jar=jetbrains
--add-opens=java.base/jdk.internal.org.objectweb.asm=ALL-UNNAMED
--add-opens=java.base/jdk.internal.org.objectweb.asm.tree=ALL-UNNAMED
EOF
...
激活软件
<code-block lang="bash">
cat >> ~/.local/share/JetBrains/Toolbox/apps/webstorm/bin/webstorm64.vmoptions <<'EOF'
-javaagent:$HOME/DevTools/jetbra/ja-netfilter.jar=jetbrains
--add-opens=java.base/jdk.internal.org.objectweb.asm=ALL-UNNAMED
--add-opens=java.base/jdk.internal.org.objectweb.asm.tree=ALL-UNNAMED
EOF
...
激活软件
<code-block lang="bash">
cat >> ~/.local/share/JetBrains/Toolbox/apps/intellij-idea-ultimate/bin/idea64.vmoptions <<'EOF'
-javaagent:$HOME/DevTools/jetbra/ja-netfilter.jar=jetbrains
--add-opens=java.base/jdk.internal.org.objectweb.asm=ALL-UNNAMED
--add-opens=java.base/jdk.internal.org.objectweb.asm.tree=ALL-UNNAMED
EOF
...
激活软件
<code-block lang="bash">
cat >> ~/.local/share/JetBrains/Toolbox/apps/clion/bin/clion64.vmoptions <<'EOF'
-javaagent:$HOME/DevTools/jetbra/ja-netfilter.jar=jetbrains
--add-opens=java.base/jdk.internal.org.objectweb.asm=ALL-UNNAMED
--add-opens=java.base/jdk.internal.org.objectweb.asm.tree=ALL-UNNAMED
EOF

...
激活软件
<code-block lang="bash">
file=~/.local/share/JetBrains/Toolbox/apps/pycharm/bin/pycharm64.vmoptions
echo "-javaagent:\$HOME/DevTools/jetbra/ja-netfilter.jar=jetbrains" >> "$file"
echo "--add-opens=java.base/jdk.internal.org.objectweb.asm=ALL-UNNAMED" >> "$file"
echo "--add-opens=java.base/jdk.internal.org.objectweb.asm.tree=ALL-UNNAMED" >> "$file"
</code-block>
软件激活码
<code-block lang="bash">
...
激活软件
<code-block lang="bash">
file=~/.local/share/JetBrains/Toolbox/apps/phpstorm/bin/phpstorm64.vmoptions
echo "-javaagent:\$HOME/DevTools/jetbra/ja-netfilter.jar=jetbrains" >> "$file"
echo "--add-opens=java.base/jdk.internal.org.objectweb.asm=ALL-UNNAMED" >> "$file"
echo "--add-opens=java.base/jdk.internal.org.objectweb.asm.tree=ALL-UNNAMED" >> "$file"
</code-block>
...
激活软件
<code-block lang="bash">
file=~/.local/share/JetBrains/Toolbox/apps/webstorm/bin/webstorm64.vmoptions
echo "-javaagent:\$HOME/DevTools/jetbra/ja-netfilter.jar=jetbrains" >> "$file"
echo "--add-opens=java.base/jdk.internal.org.objectweb.asm=ALL-UNNAMED" >> "$file"
echo "--add-opens=java.base/jdk.internal.org.objectweb.asm.tree=ALL-UNNAMED" >> "$file"
</code-block>
...
<tab title="IntelliJIDEA">
激活软件
<code-block lang="bash">
file=~/.local/share/JetBrains/Toolbox/apps/intellij-idea-ultimate/bin/idea64.vmoptions
echo "-javaagent:\$HOME/DevTools/jetbra/ja-netfilter.jar=jetbrains" >> "$file"
echo "--add-opens=java.base/jdk.internal.org.objectweb.asm=ALL-UNNAMED" >> "$file"
echo "--add-opens=java.base/jdk.internal.org.objectweb.asm.tree=ALL-UNNAMED" >> "$file"
</code-block>
...
激活软件
<code-block lang="bash">
file=~/.local/share/JetBrains/Toolbox/apps/clion/bin/clion64.vmoptions
echo "-javaagent:\$HOME/DevTools/jetbra/ja-netfilter.jar=jetbrains" >> "$file"
echo "--add-opens=java.base/jdk.internal.org.objectweb.asm=ALL-UNNAMED" >> "$file"
echo "--add-opens=java.base/jdk.internal.org.objectweb.asm.tree=ALL-UNNAMED" >> "$file"
</code-block>
